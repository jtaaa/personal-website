...
const info = {
  "/info/blueprint": {
    ...
    generalInfo: {
      description:
        "Blueprint is a student group that partners with non-profit organizations to develop tech solutions, such as website, mobile apps and backend services, free of charge.",
      infoPoints: [
        {
          label: "Role:",
    ...
    projectsInfo: [
      {
        ...
        description:
          "Best Friends runs America’s largest no-kill animal sanctuary and aims to achieve nation-wide no-kill status by 2025.",
        sections: [
          {
            ...
            subsections: [
              {
                ...
                type: "paragraph",
                contents: ["I worked mostly on the backend."]
              },
              {
  ...
  "/info/acs": {
    ...
    generalInfo: {
      description:
        "The University of Waterloo ACS is a student group that fosters a strong Caribbean community and promotes Caribbean culture.",
      infoPoints: [
        {
          label: "Role:",
  ...
  "/info/teleios": {
    ...
    generalInfo: {
      description:
        "Teleios Systems Limited is a leader in cloud, mobile and automation services in the Caribbean, across the government, energy, retail, finance and telecommunications industries.",
      infoPoints: [
        {
          label: "Role:",
  ...
  "/info/massy": {
    ...
    generalInfo: {
      description:
        "Massy Technologies InfoCom is part of the largest conglomerate in the Caribbean, Massy Holdings Limited, and provides software and IT solutions to customers across the Caribbean.",
      infoPoints: [
        {
          label: "Role:",
